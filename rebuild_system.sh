...
if [[ "$HOSTNAME" == "nene" ]]; then
  ...
  sudo nixos-rebuild switch --flake '.#' --show-trace --override-input filter-tweets path:/home/ian/.nix/common/filter-tweets --option extra-substituters ssh-ng://nix-ssh@nene
